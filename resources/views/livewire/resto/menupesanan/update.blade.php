            ...
            <div class="modal-body">
                <form enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" wire:model="gambar" id="gambar_update" class="form-control" wire:change="$emit('selectGambarUpdate')">
                        {{-- <input type="file" wire:model="gambar" id="gambar_update" class="form-control""> --}}
                        @error('gambar')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
