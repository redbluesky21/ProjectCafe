            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        @endif
                        @include('livewire.resto.menupesanan.create')
                        @include('livewire.resto.menupesanan.update')
                        <div class="row">
                            <div class="col-lg-12">
...
@push('script')
    <script>
        $(document).ready(function(){
            ...
            window.livewire.on('selectGambar', () => {
            ...
            window.livewire.on('selectGambarUpdate', () => {
                let inputField = document.getElementById('gambar_update');
                let file = inputField.files[0];
                let reader = new FileReader();
