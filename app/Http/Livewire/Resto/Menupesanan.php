...
class Menupesanan extends Component
{
    ...
    protected $listeners = ['pagination' => 'selectPagination', 'deleteAllMenupesanan', 'gambarUpload', 'inputHargaHandle', 'fileUpload'];
